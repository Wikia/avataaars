...
export default class HarryPotter extends React.Component {
  static optionValue = 'HarryPotter'
  ...
  render() {
    ...
    return (
      <g>
        ...
        <g>
          <defs>
            <clipPath id="clip-Harry_Poter_scar_">
              <rect width="645" height="673" />
            </clipPath>
          </defs>
          <g id="Harry_Poter_scar_" data-name="Harry Poter (scar)" clipPath="url(#clip-Harry_Poter_scar_)">
            <path id="Path_6" data-name="Path 6" d="M1206.172,277.036l4.943,23.936-15.572-1.967,7.205,20.365" style={{ 'transform': 'scale(0.6) translate(-983px, -173px' }} fill="none" stroke="#8e4552" strokeLinecap="round" strokeWidth="3" />
          </g>
        </g>
      </g>
    )
